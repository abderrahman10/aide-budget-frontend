    ...
    return (
        <div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden">
            <div className="flex flex-column align-items-center justify-content-center">
                {/* <Image src={logo} alt="Sakai logo" className="mb-5 w-6rem flex-shrink-0"  width={100}
            height={100} /> */}
                <div
                    style={{
                        borderRadius: '56px',
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        ...
                        <div className="text-600 mb-5">Ressource demandée non disponible</div>
                        <Link href="/" className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                            ...
                            <span className="ml-4 flex flex-column">
                                <span className="text-900 lg:text-xl font-medium mb-1">Questions Fréquemment Posées</span>
                            </span>
                        </Link>
